...
$table_creation_query = "CREATE TABLE IF NOT EXISTS redwanul (
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    if (isset($_POST['add'])) {
        ...
        $email = $_POST['email'];
        $phone = $_POST['phone'];
        $insert_query = "INSERT INTO redwanul (name, email, phone) VALUES ('$name', '$email', '$phone')";
    ...
    if (isset($_POST['update'])) {
        ...
        $email = $_POST['email'];
        $phone = $_POST['phone'];
        $update_query = "UPDATE redwanul SET name='$name', email='$email', phone='$phone' WHERE id=$id";
    ...
    if (isset($_POST['delete'])) {
        $id = $_POST['id'];
        $delete_query = "DELETE FROM redwanul WHERE id=$id";
...
$select_query = "SELECT * FROM redwanul";
